...
// import { UserPreviewCard } from "../PreviewCard";
import PlainButton from "../PlainButton";
import notification from "../notification";
// import User from "../../services/user";
const axios:any = {}
const UserPreviewCard:any = {}
const User:any = {}
  ...
  const addPermission = useCallback(
    (userId, accessType = "modify") =>
      axios
        ...
        .catch(() => notification.error.call({},"Could not grant permission to the user")),
    [url]
  );
  ...
  const removePermission = useCallback(
    (userId, accessType = "modify") =>
      axios
        ...
        .catch(() => notification.error.call({},"Could not remove permission from the user")),
    [url]
  );
...
function PermissionsEditorDialog({ dialog, author, context, aclUrl }) {
  ...
  const loadUsersWithPermissions = useCallback(() => {
    ...
    loadGrantees()
      .then(setGrantees)
      .catch(() => notification.error.call({},"Failed to load grantees list"))
