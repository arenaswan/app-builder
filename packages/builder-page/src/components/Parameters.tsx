...
import { SortableContainer, SortableElement, DragHandle } from "@steedos-ui/builder-viz-lib/lib/components/sortable";
...
export default class Parameters extends React.Component {
  ...
  componentDidUpdate = prevProps => {
    const { parameters, disableUrlUpdate } = this.props as any;
  ...
  setPendingValue = (param, value, isDirty) => {
    const { onPendingValuesChange } = this.props as any;
  ...
  moveParameter = ({ oldIndex, newIndex }) => {
    const { onParametersEdit } = this.props as any;
  ...
  applyChanges = () => {
    const { onValuesChange, disableUrlUpdate } = this.props as any;
    this.setState(({ parameters }: any) => {
  ...
  renderParameter(param, index) {
    const { editable } = this.props as any;
    return (
  ...
  render() {
    const { parameters } = this.state as any;
    const { sortable, appendSortableToParent } = this.props as any;
