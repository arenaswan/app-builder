...
function NameInput({ name, type, onChange, existingNames, setValidation }) {
  ...
  return (
    <Form.Item required label="Keyword" help={helpText} validateStatus={(validateStatus as any)} {...formItemProps}>
      ...
      <Form layout="horizontal" onFinish={onConfirm} id={paramFormId}>
        ...
        <Form.Item label="Type" {...formItemProps}>
          <Select value={param.type} onChange={type => setParam({ ...param, type })} data-test="ParameterTypeSelect">
            ...
            <Option disabled key="dv1" value="dv1">
            ...
            <Option disabled key="dv2" value="dv2">
              <Divider className="select-option-divider" />
            </Option>
