...
import DateParameter from "./dynamic-parameters/DateParameter";
import DateRangeParameter from "./dynamic-parameters/DateRangeParameter";
...
class ParameterValueInput extends React.Component {
  ...
  componentDidUpdate = prevProps => {
    const { value, parameter } = this.props as any;
  ...
  renderDateParameter() {
    const { type, parameter } = this.props as any;
  ...
  renderEnumInput() {
    const { enumOptions, parameter } = this.props as any;
    const { value } = this.state as any;
    ...
    return (
      <SelectWithVirtualScroll
        className={(this.props as any).className}
        mode={(parameter as any).multiValuesOptions ? "multiple" : "tags"}
  ...
  renderQueryBasedInput() {
    const { queryId, parameter } = this.props as any;
    const { value } = this.state as any;
    return (
  ...
  render() {
    const { isDirty } = this.state as any;
