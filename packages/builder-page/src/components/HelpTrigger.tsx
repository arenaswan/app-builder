...
import DynamicComponent, { registerComponent } from "./DynamicComponent";
...
export function helpTriggerWithTypes(types, allowedDomains = [], drawerClassName = null) {
  return class HelpTrigger extends React.Component {
    ...
    loadIframe = url => {
      ...
      (this.iframeRef.current as any).src = url;
            ...
            <div className="drawer-wrapper">
              ...
              {this.state.error && (
                <BigMessage icon="fa-exclamation-circle" className="help-message">
                  ...
                  <br />
                  {/* eslint-disable-next-line react/jsx-no-target-blank */}
                  <Link href={(this.state.error as any)} target="_blank" rel="noopener">
                    Click here
                  </Link>{" "}
