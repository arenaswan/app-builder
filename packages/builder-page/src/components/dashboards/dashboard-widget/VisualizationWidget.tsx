...
import ExpandedWidgetDialog from "../../dashboards/ExpandedWidgetDialog";
import EditParameterMappingsDialog from "../../dashboards/EditParameterMappingsDialog";
import VisualizationRenderer from "../../visualizations/VisualizationRenderer";

import Widget from "./Widget";

function visualizationWidgetMenuOptions({ isPublic, widget, canEditDashboard, onParametersEdit }) {
...
class VisualizationWidget extends React.Component {
  ...
  componentDidMount() {
    const { widget, onLoad } = this.props as any;
  ...
  expandWidget = () => {
    ExpandedWidgetDialog.showModal({ widget: (this.props as any).widget, filters: (this.state as any).localFilters });
  };

  editParameterMappings = () => {
    const { widget, dashboard, onRefresh, onParameterMappingsChange } = this.props as any;
  ...
  renderVisualization() {
    const { widget, filters } = this.props as any;
    const widgetQueryResult = widget.getQueryResult();
  ...
  render() {
    const { widget, isLoading, isPublic, canEdit, isEditing, onRefresh } = this.props as any;
    const { localParameters } = this.state as any;
    const widgetQueryResult = widget.getQueryResult();
