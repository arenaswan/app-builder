...
import DynamicButton from "../dynamic-parameters/DynamicButton";
...
class DynamicDatePicker extends React.Component {
  ...
  dateComponentRef: React.RefObject<unknown>;
  ...
  onDynamicValueSelect = dynamicValue => {
    ...
    (this.dateComponentRef.current as any).focus();
  };

  render() {
    const { type, value, className, dateOptions, dynamicButtonOptions, onSelect } = this.props as any;
