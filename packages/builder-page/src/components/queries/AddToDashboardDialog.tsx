      ...
      .then(dashboard => {
        ...
        (notification as any).success(
          ...
          <React.Fragment>
            ...
            <QueryTagsControl isDraft={dashboard.is_draft} tags={dashboard.tags} isArchived={false}/>
          </React.Fragment>,
          { key }
        );
      })
      .catch(() => {
        (notification as any).error("Widget not added.");
      })
      .finally(() => {
          ...
          renderItem={(d: any) => (
            <List.Item
              ...
              <div className="add-to-dashboard-dialog-item-content">
                {d.name}
                <QueryTagsControl isDraft={d.is_draft} tags={d.tags} isArchived={false}/>
              </div>
            </List.Item>
          )}
        />
