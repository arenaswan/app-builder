...
import { SchemaItemType } from "../../queries/SchemaBrowser";
...
const QueryEditor: any = React.forwardRef(function(
  _props,
  ref
) {
  const { className, syntax, value, autocompleteEnabled, schema, onChange, onSelectionChange, ...props } = _props as any
  ...
  const initEditor = useCallback(editor => {
    ...
    editor.on("focus", () => {
      notificationCleanup = (srNotify as any)({
